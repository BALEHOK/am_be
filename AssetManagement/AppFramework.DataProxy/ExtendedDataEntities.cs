...
using EFTracingProvider;
    ...
    public class ExtendedDataEntities : DataEntities
    {
        private TextWriter logOutput;

        public ExtendedDataEntities()
            : this("name=DataEntities")
        {
        }

        public ExtendedDataEntities(EntityConnection connection)
            : base(connection)
        {

        }

        public ExtendedDataEntities(string connectionString)
