<%@ Page Language="C#" AutoEventWireup="True" MasterPageFile="~/MasterPages/MasterPageBase.master"
    CodeBehind="SearchByType.aspx.cs" Inherits="AssetSite.Search.SearchByType" meta:resourcekey="PageResource1" %>
...
<%@ Register Src="~/Controls/PlaceAndZipControl.ascx" TagName="AssetPlaceControl" TagPrefix="amc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PlaceHolderSearchBox" runat="server">
    <div class="reglament">
        <uc1:searchtabs runat="server" id="SearchTabs" ActiveSearchType="SearchByType" />
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <amc:AssetPlaceControl runat="server" id="apcPlace" Visible='<%# CurrentType.Attributes[((AttributeElement)Container.DataItem).AttributeId].Type == AppFramework.ConstantsEnumerators.Enumerators.DataType.Place %>'/>
                ...
                <tr>
                    ...
                    <td align="right">
                        <asp:Button ID="Button1" runat="server" Text="Search" OnClick="ButtonSearch_Click"
                            meta:resourcekey="Button1Resource2" ValidationGroup="1" />
                    </td>
                </tr>
                <tr>
                    <td style="padding-bottom: 5px; width: 30px;">
