...
CodeBehind="SearchByBarCode.aspx.cs" Inherits="AssetSite.Search.SearchByBarCode" meta:resourcekey="PageResource1" %>
                        ...
                        <tr>
                            <td valign="middle">
                                <asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl="#" 
                                    meta:resourcekey="HyperLink5Resource1">BarCode</asp:HyperLink>
                            </td>
                        </tr>
                    </table>
                </div>
