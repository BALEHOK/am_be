...
namespace AssetSite.Controls
{
    public partial class SearchParametersPanel : UserControl
    {
        ...
        {
            get {
                return long.Parse(ddlTypes.SelectedValue);
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            CurrentType = new OneType(
                AssetTypeRepository.GetByUid(long.Parse(ddlTypes.SelectedValue)), 
                UnitOfWork,
                AssetsService,
                AssetTypeRepository);
        }
        ...
        protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (CurrentAttributes[index].DateType == Enumerators.DataType.Asset ||
                ...
                CurrentAttributes[index].DateType == Enumerators.DataType.DynList)
            {
                var nasset = new AssetAttribute(CurrentType.AssetAttributes[CurrentAttributes[index].AttributeId].Configuration, null,
        ...
        private void SaveValueChangesRepeater()
        {
            ...
            foreach (RepeaterItem row in Repeater1.Items)
            {
                ...
                if (adlAssets.Visible)
                {
                    ...
                    {
                        var nasset = new AssetAttribute(CurrentType.AssetAttributes[CurrentAttributes[i].AttributeId].Configuration, 
                            null,
