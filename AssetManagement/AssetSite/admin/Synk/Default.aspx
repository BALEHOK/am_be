<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="AssetSite.admin.Synk.Default"
    MasterPageFile="~/MasterPages/MasterPageDefault.master" Trace="false" Theme="Default"
    meta:resourcekey="PageResource1" %>

<%@ Register TagPrefix="tvc" TagName="sharedResourcesControl" Src="~/Controls/ShowSharedResources.ascx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PlaceHolderMiddleColumn" runat="server">
    ...
    <div id="main-container">
        <div class="wizard-header">
            <asp:Label runat="server" ID="pageTitle" meta:resourcekey="pageTitleResource1">Assets Synchronization</asp:Label>
        </div>
        <div class="panel">
            <div class="panelheader">
                <%= SynkWizard.ActiveStep.Title %>
            </div>
            <amc:MessagePanel runat="server" ID="messagePanel" Style="margin: 5px 0 5px 10px"
                meta:resourcekey="messagePanelResource1" />
            <div class="panelcontent">
                <asp:Wizard ID="SynkWizard" runat="server" Width="100%" CancelButtonText="<% $Resources:Global, CancelText %>"
                    ...
                    OnCancelButtonClick="SynkWizard_Cancel" OnFinishButtonClick="SynkWizard_Finish"
                    OnNextButtonClick="SynkWizard_Next" DisplaySideBar="False" ActiveStepIndex="0">
                    <WizardSteps>
                        <asp:WizardStep ID="WizardStep1" runat="server" Title="Step 1 &mdash; Asset Type for data synchronization"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:CompareValidator Operator="GreaterThan" ValueToCompare="0" ControlToValidate="atList"
                                            runat="server" Type="Integer" ErrorMessage="Please choose asset type to assets synchronization"
                        ...
                        <asp:WizardStep ID="WizardStep2" runat="server" Title="Step 2 &mdash; DataSource"
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    <td>
                                        <asp:RadioButtonList Enabled="False" ID="dataSourceTypesList" CssClass="datasource" runat="server"
                                ...
                                <tr>
                                    <td>
                                        <div id="wFile" class="wrapper" style="display: none;" >
                                            <tvc:sharedResourcesControl runat="server" ID="showSharedResources" /><br />
                                        </div>
                        ...
                        <asp:WizardStep ID="WizardStep3" runat="server" Title="Step 3 &mdash; DataSource settings"
                            ...
                            <p>
                                <asp:Literal ID="Literal1" runat="server" meta:resourcekey="Literal1Resource1">Please specify the sheets to synchronization data from:</asp:Literal></p>
                        ...
                        <asp:WizardStep ID="WizardStep4" runat="server" Title="Finish &mdash; Fields binding"
                                    ...
                                    <asp:TemplateField HeaderText="DataSource fields" meta:resourcekey="TemplateFieldResource2" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <span class="bindable bindable_<%# Container.DataItemIndex %>">
                                                <asp:DropDownList ID="datasourceField" CssClass="datasourceField" runat="server" meta:resourcekey="datasourceFieldResource1">
                                                </asp:DropDownList>
                                            </span>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Default value" meta:resourcekey="TemplateFieldResource3" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:Panel runat="server" ID="ctrlWrapper" meta:resourcekey="ctrlWrapperResource1">
                                                <span id="<%# Container.DataItemIndex %>"><span class="expandable" style="display: inline">
                            ...
                            <p>
                                <asp:DropDownList ID="synchronizationFieldList" runat="server" meta:resourcekey="datasourceFieldResource1">
                                </asp:DropDownList>
                            </p>
                            ...
                            <p>
                                <asp:Literal runat="server" ID="lblPressFinish" meta:resourcekey="lblPressFinishResource1">Click Finish to create the synchronization task.</asp:Literal></p>
                        </asp:WizardStep>
                    </WizardSteps>
                </asp:Wizard>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.datasourceField').change(function () {
        ...
        function AssignValue(id) {
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/Synk/Default.aspx/AssignValue',
        ...
        function RemoveValue(id) {
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/Synk/Default.aspx/RemoveValue',
                data: '{index: ' + id + '}',
                dataType: 'json',
                contentType: 'application/json; charset=utf-8',
                success: callback,
