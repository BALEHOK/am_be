...
<asp:Content ID="Content2" ContentPlaceHolderID="PlaceHolderMiddleColumn" Runat="Server">
    ...
    <div class="panel appsettings" style="float:left;">
    ...
    <div class="panel configusers" style="float:right;">
        <div class="panelheader">
    ...
    <div class="panel configobjects obsolete" style="float:left;" runat="server" ID="panelConfigureObjects">
        <div class="panelheader">
            <asp:Label ID="Label1" runat="server" Text="Configuratie objecten (assets)" 
                meta:resourcekey="Label1Resource1"></asp:Label> (obsolete)
        </div>
        <div class="panelcontent">
            <p>       
    ...
    <div class="panel configtaxonomy obsolete" style="float:right;" runat="server" ID="panelConfigureTaxonomies">
        <div class="panelheader">
            <asp:Label runat="server" ID="lblTaxHeader" 
                Text="Configuratie categorieen/taxononomieen" 
                meta:resourcekey="lblTaxHeaderResource1"></asp:Label> (obsolete)
        </div>
        <div class="panelcontent">
             <p>                
