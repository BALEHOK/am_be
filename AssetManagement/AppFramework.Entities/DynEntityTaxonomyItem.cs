...
namespace AppFramework.Entities
{
    ...
    public partial class DynEntityTaxonomyItem: IObjectWithChangeTracker, INotifyPropertyChanged, IDataEntity
    {
        ...
        private void FixupDynEntityConfig(DynEntityConfig previousValue)
        {
            ...
            if (previousValue != null && previousValue.DynEntityTaxonomyItems.Contains(this))
            {
                previousValue.DynEntityTaxonomyItems.Remove(this);
            }
    
            if (DynEntityConfig != null)
            {
                if (!DynEntityConfig.DynEntityTaxonomyItems.Contains(this))
                {
                    DynEntityConfig.DynEntityTaxonomyItems.Add(this);
                }
        ...
        private void FixupTaxonomyItem(TaxonomyItem previousValue)
        {
            ...
            {
                if (!TaxonomyItem.DynEntityTaxonomyItems.Contains(this))
                {
                    TaxonomyItem.DynEntityTaxonomyItems.Add(this);
                }
