...
namespace AppFramework.Entities
{
    ...
    public partial class MultipleAssetsHistory: IObjectWithChangeTracker, INotifyPropertyChanged, IDataEntity
    {
        ...
        [DataMember]
        public long RelatedDynEntityUid
        {
            get { return _relatedDynEntityUid; }
            set
            {
                if (_relatedDynEntityUid != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'RelatedDynEntityUid' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _relatedDynEntityUid = value;
                    OnPropertyChanged("RelatedDynEntityUid");
                }
            }
        }
        private long _relatedDynEntityUid;
