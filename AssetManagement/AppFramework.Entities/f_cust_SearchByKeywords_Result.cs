...
namespace AppFramework.Entities
{
    ...
    public partial class f_cust_SearchByKeywords_Result : INotifyComplexPropertyChanging, INotifyPropertyChanged
    {
        ...
        public static void RecordComplexOriginalValues(String parentPropertyName, f_cust_SearchByKeywords_Result complexObject, ObjectChangeTracker changeTracker)
        {
