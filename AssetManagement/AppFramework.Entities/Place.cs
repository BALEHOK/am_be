...
namespace AppFramework.Entities
{
    ...
    public partial class Place: IObjectWithChangeTracker, INotifyPropertyChanged, IDataEntity
    {
        ...
        public long PlaceId
        {
            ...
            set
            {
                if (_placeId != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'PlaceId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _placeId = value;
