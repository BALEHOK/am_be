...
namespace AppFramework.Core.Classes
{
    public interface IDynamicListsService
    {
        ...
        IEnumerable<DynamicListValue> GetLegacyListValues(long dynEntityConfigUid,
            long dynEntityAttribConfigUid, long assetUid);
    ...
    public class DynamicListsService : IDynamicListsService
    {
        ...
        public IEnumerable<DynamicListValue> GetLegacyListValues(
            long dynEntityConfigUid,
            long dynEntityAttribConfigUid,
            long assetUid)
        {
            var predicate = PredicateBuilder.True<DynListValue>();
            predicate = predicate.And(dlv => dlv.DynEntityAttribConfigUid == dynEntityAttribConfigUid);
            predicate = predicate.And(dlv => dlv.DynEntityConfigUid == dynEntityConfigUid);
