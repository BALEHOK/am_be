...
BEGIN
	...
	BEGIN
		...
		SET @field = @field + 'CASE WHEN ' + @dbRefLnkName + '.' + @dbRefTableFieldname + ' IS NULL THEN ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: ""}'' ELSE ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: "'' + CONVERT(nvarchar(3000),' + @dbRefLnkName + '.' + @dbRefTableFieldname + ') + ''"}''  END  '
	END
	...
	BEGIN
		...
		ELSE BEGIN
			SET @ttname = '#t' + CONVERT(varchar(10), @linkTablenameId);
		END
		SET @field = @field + ' CASE WHEN ' + @ttname + '.Value IS NULL THEN ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: ""}'' ELSE ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: "'' + ' +  @ttname + '.Value + ''"}'' END '		
	END
	...
	BEGIN
		...
		SET @field = @field + ' CASE WHEN ' + @ttname2 + '.Value IS NULL THEN ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: ""}'' ELSE ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: "'' + ' +  @ttname2 + '.Value + ''"}'' END ';
	...
	BEGIN
		IF @culture = 'nl-BE' OR @culture = 'nl-NL' OR @culture = 'fr-FR'
			SET @field = @field + ' CASE WHEN ' + @PrimaryTable + '.' + @TableFieldname + ' IS NULL THEN ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: ""}'' ELSE ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: "'' + CONVERT(nvarchar(20),' + @PrimaryTable + '.' + @TableFieldname + ', 103) + ''"}''  END  '
		ELSE 
			SET @field = @field + ' CASE WHEN ' + @PrimaryTable + '.' + @TableFieldname + ' IS NULL THEN ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: ""}'' ELSE ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: "'' + CONVERT(nvarchar(20),' + @PrimaryTable + '.' + @TableFieldname + ') + ''"}''  END  '
	END
	ELSE IF @DataType = 'float'
	BEGIN
		IF @culture = 'nl-BE' OR @culture = 'nl-NL' OR @culture = 'fr-FR'
			SET @field = @field + ' CASE WHEN ' + @PrimaryTable + '.' + @TableFieldname + ' IS NULL THEN ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: ""}'' ELSE ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: "'' + REPLACE(LTRIM(STR(' + @PrimaryTable + '.' + @TableFieldname + ', 10, 2)), ''.'', '','') + ''"}''  END  '
		ELSE
			SET @field = @field + ' CASE WHEN ' + @PrimaryTable + '.' + @TableFieldname + ' IS NULL THEN ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: ""}'' ELSE ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: "'' + LTRIM(STR(' + @PrimaryTable + '.' + @TableFieldname + ', 10, 2)) + ''"}''  END  ';
	END
	ELSE IF @DataType = 'money' OR @DataType = 'usd' OR @DataType = 'euro'
	BEGIN
		IF @culture = 'nl-BE' OR @culture = 'nl-NL' OR @culture = 'fr-FR'
			SET @field = @field + ' CASE WHEN ' + @PrimaryTable + '.' + @TableFieldname + ' IS NULL THEN ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: ""}'' ELSE ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: "'' + REPLACE(CONVERT(nvarchar(25), ' + @PrimaryTable + '.' + @TableFieldname + ', 0), ''.'', '','') + ''"}''  END  '
		ELSE
			SET @field = @field + ' CASE WHEN ' + @PrimaryTable + '.' + @TableFieldname + ' IS NULL THEN ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: ""}'' ELSE ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: "'' + CONVERT(nvarchar(25), ' + @PrimaryTable + '.' + @TableFieldname + ', 0) + ''"}''  END  '
	END
	ELSE IF @DataType = 'richtext'
	BEGIN
		SET @field = @field + ' CASE WHEN ' + @PrimaryTable + '.' + @TableFieldname + ' IS NULL THEN ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: ""}'' ELSE ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: "'' + dbo.StripHTML(' + @PrimaryTable + '.' + @TableFieldname + ') + ''"}''  END  '
	END
	
	-- No special formatting required, just paste the value
	ELSE BEGIN
		SET @field = @field + ' CASE WHEN ' + @PrimaryTable + '.' + @TableFieldname + ' IS NULL THEN ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: ""}'' ELSE ' + @delimiter + ' ''{ key: "' + @TableFieldname + '", value: "'' + CONVERT(nvarchar(1000), ' + @PrimaryTable + '.' + @TableFieldname + ') + ''"}''  END  '
	END;
	...
	BEGIN		
		...
		SET @sql = CONVERT(NVARCHAR(max), @creatett + ' ' + 
				...
				'SELECT prim.DynEntityUid, ' + 
						...
						CONVERT(nvarchar(450),' + @DisplayValues + ') AS DisplayValues, ' +
		...
		if (@DisplayValues like '%PhoneNumber%')
		begin
			SELECT @sql
		end
