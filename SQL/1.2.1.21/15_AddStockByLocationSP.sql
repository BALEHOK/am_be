...
-- =============================================
CREATE PROCEDURE [dbo].[_cust_GetStocksByLocation]
...
BEGIN
	...
	(select LocationId, FromLocationId, TransactionTypeUid, StockCount from DynEntityTransaction where DynEntityId = 2 and DynEntityConfigId = 224)
